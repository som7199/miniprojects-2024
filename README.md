...
- IoT 기기 간 통신 방법
 ...
 - MQTT 통신
    ...
    - Win/C# : MQTT.NET Nuget 패키지 설치, 수신(subscriber)
        - M2Mqtt : 가볍게 쓸 수 있음, 업데이트가 안 됨
        - MQTTNet : MS에서 개발, 무거움, 최신까지 업데이트 잘 됨
...
- 스마트홈 연동 클래스 미니 프로젝트 마무리
    ...
    - 실행결과
        ![스마트홈1](https://raw.githubusercontent.com/som7199/miniprojects-2024/main/images/mp002.png)
